...
import argparse
from adversarial_lab.core import ExperimentConfig, run_evaluate
def main():
    p = argparse.ArgumentParser(description="Evaluate adversarial robustness")
    ...
    args = p.parse_args()
    run_evaluate(ExperimentConfig.from_cli(args), checkpoint=args.checkpoint)

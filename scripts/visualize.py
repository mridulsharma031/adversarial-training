...
import argparse
from adversarial_lab.core import ExperimentConfig, run_visualize
def main():
    p = argparse.ArgumentParser(description="Visualize adversarial examples")
    ...
    args = p.parse_args()
    run_visualize(ExperimentConfig.from_cli(args), checkpoint=args.checkpoint)
